conversations = [
    ...
    ("latest news", "..."),
    ("india news", "..."),
    ("who inspires you", "Personally, I find manasa very inspiring. I might not be very fair though.."),
    ("who is your inspiration", "Personally, I find manasa very inspiring. I might not be very fair though.."),
    ("who motivates you", "Personally, I find manasa very inspiring. I might not be very fair though.."),
